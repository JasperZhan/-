...
#include "sq_bin_tree_node.h"								// 顺序存储二叉树结点类模板
...
//  二叉树方法声明及重载编译系统默认方法声明:
	...
	SqBinaryTree(const SqBinaryTree<ElemType> &copy);		// 复制构造函数模板
...
// 操作结果：用e返回结点cur的元素值,则操作成功,返回SUCCESS,否则返回FAIL
{
